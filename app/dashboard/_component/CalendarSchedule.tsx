        ...
        <Box className='schedule-container flex flex-col gap-4 [&>*]:cursor-pointer justify-center '>
          <Box className='flex items-center gap-3 hover:bg-slate-100 p-2'>
            ...
            <Box className='flex flex-col flex-grow'>
              ...
              <p className='text-slate-500 text-xs'>via Zoom</p>
            </Box>
            <p className='text-slate-500  text-xs self-start'>10:00 am</p>
          </Box>
          <Box className='flex items-center gap-3 hover:bg-slate-100 p-2'>
            <Box className='p-2 bg-indigo-100  rounded-md'>
              <VideoIcon color='rgba(79,70,229,1)' fill='rgba(79,70,229,1)' />
            ...
            <p className='text-slate-500 self-start text-xs '>01:00 pm</p>
          </Box>
          <Box className='flex items-center gap-3 hover:bg-slate-100 p-2'>
            ...
            <p className='text-slate-500 text-xs self-start'>03:00 pm</p>
          </Box>
          <Box className='flex items-center gap-3 hover:bg-slate-100 p-2'>
            ...
            <p className='text-slate-500  text-xs self-start'>06:00 pm</p>
          </Box>
        </Box>
      </CardContent>
    </Card>
